...
\subsubsection{November 30, 2023}\label{november-30-2023}
...
\PY{c+c1}{\PYZsh{} 1 \PYZhy{} 3}
\PY{k+kn}{import} \PY{n+nn}{random}
\PY{n}{random}\PY{o}{.}\PY{n}{seed}\PY{p}{(}\PY{l+m+mi}{10}\PY{p}{)}

\PY{n}{int\PYZus{}list} \PY{o}{=} \PY{p}{[}\PY{p}{]}
\PY{n}{n} \PY{o}{=} \PY{l+m+mi}{50}
\PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{n}\PY{p}{)}\PY{p}{:}
 \PY{n}{int\PYZus{}list}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{random}\PY{o}{.}\PY{n}{randint}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{15}\PY{p}{)}\PY{p}{)}
\PY{n+nb}{print}\PY{p}{(}\PY{n}{int\PYZus{}list}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{p}{[}\PY{l+m+mi}{10}\PY{p}{,} \PY{l+m+mi}{30}\PY{p}{]}\PY{p}{:}
    \PY{n+nb}{print}\PY{p}{(}\PY{n}{int\PYZus{}list}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\PY{n}{az\PYZus{}upper} \PY{o}{=} \PY{n}{string}\PY{o}{.}\PY{n}{ascii\PYZus{}uppercase}


\PY{n}{az\PYZus{}list} \PY{o}{=} \PY{p}{[}\PY{p}{]}

\PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n}{az\PYZus{}upper}\PY{p}{:}
    \PY{n}{az\PYZus{}list}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{i}\PY{p}{)}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{set\PYZus{}1} \PY{o}{=} \PY{p}{\PYZob{}}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{4}\PY{p}{,}\PY{l+m+mi}{5}\PY{p}{\PYZcb{}}
...
\PY{c+c1}{\PYZsh{}4. The length of set\PYZus{}1 is 5, set\PYZus{}2 is 15, set\PYZus{}3 is 12}
\PY{n+nb}{len}\PY{p}{(}\PY{n}{set\PYZus{}1}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n+nb}{len}\PY{p}{(}\PY{n}{set\PYZus{}2}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n+nb}{len}\PY{p}{(}\PY{n}{set\PYZus{}3}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\PY{k}{def} \PY{n+nf}{def\PYZus{}value}\PY{p}{(}\PY{p}{)}\PY{p}{:}
    \PY{k}{return} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Not Present}\PY{l+s+s1}{\PYZsq{}}

\PY{n}{dict\PYZus{}1} \PY{o}{=} \PY{n}{defaultdict}\PY{p}{(}\PY{n}{def\PYZus{}value}\PY{p}{)}

\PY{n}{dict\PYZus{}1}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{int\PYZus{}list}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=} \PY{n}{int\PYZus{}list}
\PY{n}{dict\PYZus{}1}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{set\PYZus{}1}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=} \PY{n}{set\PYZus{}1}
\PY{n}{dict\PYZus{}1}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{set\PYZus{}2}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=} \PY{n}{set\PYZus{}2}
\PY{n}{dict\PYZus{}1}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{set\PYZus{}3}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=} \PY{n}{set\PYZus{}3}

\PY{n}{dict\PYZus{}2} \PY{o}{=} \PY{p}{\PYZob{}}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{set\PYZus{}1}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{n}{set\PYZus{}1}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{az\PYZus{}list}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{n}{az\PYZus{}list}\PY{p}{\PYZcb{}}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{}4 continues}

\PY{n}{set\PYZus{}4} \PY{o}{=} \PY{n+nb}{set}\PY{p}{(}\PY{n}{dict\PYZus{}1}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{az\PYZus{}list}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,}\PY{p}{)}

\PY{n+nb}{len}\PY{p}{(}\PY{n}{set\PYZus{}4}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{}4 continues}
\PY{n+nb}{len}\PY{p}{(}\PY{n}{dict\PYZus{}2}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{az\PYZus{}list}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}

\PY{c+c1}{\PYZsh{}The length of set\PYZus{}4 is 9 and length of len(dict\PYZus{}2[\PYZsq{}az\PYZus{}list\PYZsq{}]) is 26.  The differences is 17}
\end{Verbatim}
\end{tcolorbox}
...
\PY{c+c1}{\PYZsh{} dictionary 2 retrieved the values of \PYZsq{}az\PYZus{}list\PYZsq{} key, as a value \PYZdq{}Not Present\PYZdq{}, so the \PYZsq{}az\PYZus{}list\PYZsq{} key of dict\PYZus{}2 was }
\PY{c+c1}{\PYZsh{} overwritten.}
\end{Verbatim}
\end{tcolorbox}
