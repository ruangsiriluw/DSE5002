...
# same as list 3 (use less memory) modified list1
list1.extend(list2)
...
#String concatenation, First is to make b in banana to upper,
# Second to return the rest of 'anana' add to the B string
