...
##############################################################################
###  SLIDE 2: Boxplot1 to compare salary between company size  ####
...
########  Evaluate US vs Non-US residence salary analysis  #################
...
##########
### Slide 4: Plot composition of company locations where US residence is employed
...
### Slide 5:  Plot of all titles by Experienced Level from US resident employees
salary_ft_df %>%
  filter(is_us_res == 'US') %>%
...
##########  Analysis of Data Scientist-related titles #################### 
...
# between US and nonUS employee and printe gt table  
...
# US vs nonUS employee residence
